...
contract Cryptos is ERC20Interface{
    ...
    // is called by the owner to transfer to another account his own tokens.
    ...
    function transferFrom(address from, address to, uint tokens) public virtual override returns (bool success){
     ...
     //on behalf of tokens owner after the owner approved another address to spend the tokens he posseses. 
}
